...
function trackInteractionExternalLinks() {
  const allLinkTags = document.querySelectorAll('header a, main a:not(main div.article-header-share a):not(.expand-minimized-form), footer a:not(footer div.social a)');
